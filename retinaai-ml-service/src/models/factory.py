...
class Model(nn.Module):
    ...
    def __init__(self, model_name: str, num_classes: int, pretrained: bool = True):
        ...
        Args:
            ...
            pretrained (bool): Load ImageNet weights. True for training.
                Pass False when restoring from a checkpoint — those weights are
                overwritten immediately, and downloading them requires internet
                access the deployment target may not have.
        """
...
class ModelFactory:
    ...
    def __init__(self, name: str, num_classes: int, pretrained: bool = True):
        ...
        Args:
            ...
            num_classes (int): The number of output classes.
            pretrained (bool): Load ImageNet weights (see Model).
        """
        self.name = name
    ...
    def __call__(self):
        ...
        return Model(self.name, self.num_classes, pretrained=self.pretrained)
